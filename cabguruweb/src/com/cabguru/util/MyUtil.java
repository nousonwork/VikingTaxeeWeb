...
public class MyUtil {
	...
	public static String doConvert(String inputDateStr){
		DateFormat fromFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS");
		fromFormat.setLenient(false);
		DateFormat toFormat = new SimpleDateFormat("dd MMMMM yyyy - h:mm a");
		toFormat.setLenient(false);
		Date date;
		String outputDateStr = "";
		try {
			System.out.println("inputDateStr = "+inputDateStr);
			date = fromFormat.parse(inputDateStr);
			outputDateStr = toFormat.format(date);
