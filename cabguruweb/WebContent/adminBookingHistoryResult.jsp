...
<meta name="author" content="VikingTaxee.com">
					...
					<div class="span12">
  					...
  					%>
								<tr>
									...
									<% if(!isBefore && !bookingStatusCode.equalsIgnoreCase("203")
											&& !bookingStatusCode.equalsIgnoreCase("204")
											&& !bookingStatusCode.equalsIgnoreCase("205")) {%>	
									<form class="form-horizontal" accept-charset="UTF-8"
										role="form" method="POST" action="/cabguruweb/mbcs">
									...
									<input type="hidden" name="bookingId"
										...
										<input
											type="hidden" id="callerPage" name="callerPage"
											value="adminBookingHistoryResult.jsp" />
										<input type="hidden" name="prevpage" value="adminBookingHistory.jsp" />
