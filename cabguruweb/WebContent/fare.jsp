...
<head>
<meta charset="utf-8">
<title>ITaxi-FareInformation</title>
...
<body>
	...
	<div class="container">
				...
				<div class="navbar-inner">
					<div class="container">
						<ul class="nav">
							...
							<li class="active"><a href="./fare.jsp">FareInformation</a></li>
		...
		<p class="lead">No matter where you go in the region, our rates do
			not change. From Minneapolis to St. Paul and all surrounding suburbs,
			we meter based on time and mileage with the following rates:</p>
			...
			<div class="span12">
				<table class="table table-condensed table-hover">
					<thead>
						<tr>
							<th></th>
							<th>Minneapolis Rates(Includes Traffic)</th>
							<th>Outside Minneapolis Rates(Includes Traffic)</th>
					...
					<tbody>
						...
						<tr>
							<td>Waiting Charge(per Hour)</td>
							<td>$24.00</td>
							<td>$24.00</td>

						</tr>
						<tr>
							<td>Cash Payment(Over $40)</td>
							<td>15% Off</td>
							<td>15% Off</td>

						</tr>
						<tr>
							<td>Card Payment(Over $40)</td>
							<td>10% Off</td>
							<td>10% Off</td>
						...
						<tr>
							<td></td>
							<td><a class="btn btn-success" href="./index.jsp">Book</a></td>
							<td><a class="btn btn-success" href="./index.jsp">Book </a></td>
