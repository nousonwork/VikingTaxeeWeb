...
%>
		...
		<div class="row-fluid">
			...
			<div class="span9">
				<div class="">
					...
					<legend>Update Driver</legend>

					</br>

					<%
														String signupMsg = (String) request.getAttribute("msg");
														if (signupMsg != null) {
					...
					<div class="area">
						<form class="form-horizontal" accept-charset="UTF-8" role="form"
							method="POST" action="/cabguruweb/ads">
							<div class="heading"></div>

							<input type="hidden" id="callerPage" name="callerPage"
								value="updateDriver.jsp" /> <input type="hidden"
								id="termsandconds" name="termsandconds" value="on" /> <input
								type="hidden" id="userId" name="driverId"
								value="<%out.print(request.getParameter("driverId")); %>" />
							...
							<div class="control-group">
								<label class="control-label" for="inputUser">Category</label>

								<div class="controls">

									<select id="driverCategory" name="driverCategory"
										class="input-medium">
										<option value="1">Company</option>
										<option value="0">Non-Company</option>
							...
							<div class="control-group">
								<label class="control-label" for="inputLast">Age</label>

								<div class="controls">
									<input id="inputLast" placeholder="E.g. 30" type="text"
										name="age"
										value="<%out.print(request.getParameter("age")); %>">
								</div>
							</div>
							...
							<div class="control-group">
								<label class="control-label" for="inputEmail">License
									Number</label>

								<div class="controls">
									<input id="inputEmail" placeholder="E.g. MN 23456" type="text"
										name="licNumber"
										value="<%out.print(request.getParameter("licNumber")); %>">
								</div>
							</div>

							<div class="control-group">
								<label class="control-label" for="textarea">Permanent
									Address</label>
								<div class="controls">
									<textarea id="textarea"
										placeholder="7300 Gallagher Drive, Minneapolis, MN 55435, USA"
										name="address"> <%out.print(request.getParameter("address")); %>
									</textarea>
								</div>
							</div>
	...
	<script>
		$( document ).ready(function() {
			...
			$('#driverCategory').val("<%=request.getParameter("driverCategory")%>");
		});
	</script>
